...
# COMANDOS
echo -e "\n${PURPLE}COMANDOS";
for i in bc vim-enhanced tar zip java*jdk tcpdump nmap-ncat bind-utils iotop sysstat net-tools filesystem lsof traceroute bash-completion rsync chrony cockpit htop zabbix-agent;
do
